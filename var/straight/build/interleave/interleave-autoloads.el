;;; interleave-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
(register-definition-prefixes "interleave" '("interleave-"))

;;;***

(provide 'interleave-autoloads)
;; Local Variables:
