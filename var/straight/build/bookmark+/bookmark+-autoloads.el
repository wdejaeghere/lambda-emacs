;;; bookmark+-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
(register-definition-prefixes "bookmark+" '("bmkp-" "bookmark-"))
...
(register-definition-prefixes "bookmark+-1" '("Info-bookmark-jump" "bmk" "bookmark"))
...
(register-definition-prefixes "bookmark+-bmu" '("bmkp-" "bookmark-bmenu-" "list-bookmarks" "menu-bar-edit-menu"))
...
(register-definition-prefixes "bookmark+-key" '("bmkp-" "menu-bar-bookmark-map"))
